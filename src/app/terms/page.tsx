...
export const metadata: Metadata = {
  ...
  description: `The terms that apply when you use ${PRODUCT_NAME}.`,
  openGraph: {
    title: `Terms of Service — ${PRODUCT_NAME}`,
    description: "The terms that apply when you use the product.",
    type: "article",
  },
...
export default function Page() {
  return (
    <LegalPage title="Terms of service" updated="August 2026">
      ...
      <h2>Beta software</h2>
      <p>
        The product is in beta. Features may change, and some modules shown in the product are
        labelled as coming soon and are not operational.
      </p>
      <h2>Account and termination</h2>
      <p>
        You may delete your account at any time. We may suspend accounts used for unlawful activity
