...
export const Route = createFileRoute("/_authenticated/app/onboarding")({
  validateSearch: z.object({ intent: z.string().optional() }),
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle>
            {step === 1 ? "Business identity" : step === 2 ? "Ownership and management" : "Governing documents"}
          </CardTitle>
        </CardHeader>
