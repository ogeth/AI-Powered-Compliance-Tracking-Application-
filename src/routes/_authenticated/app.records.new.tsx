...
export const Route = createFileRoute("/_authenticated/app/records/new")({
  component: Generator,
});
...
function Generator() {
  ...
  useEffect(() => {
    if (business.isFetched && !business.data) {
      navigate({ to: "/app/onboarding", search: { intent: "record" } });
    }
  }, [business.isFetched, business.data, navigate]);
          ...
          <CardContent className="space-y-5">
            ...
            <div className="flex justify-between">
              <Button variant="ghost" asChild>
                <Link to="/app">Save and exit</Link>
              </Button>
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link to="/app/business-profile">Edit business profile</Link>
            </Button>
            ...
            {riskFlags.length > 0 ? (
              <div className="flex gap-3 rounded-lg border border-attention/40 bg-attention-soft p-4 text-sm text-attention-foreground">
                ...
                <div>
                  ...
                  <p className="mt-1">
                    Matters like this often depend on your operating agreement and tax position. You can
                    still continue — the record will be flagged so you can involve an accountant or
                    lawyer.
                  </p>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm">
            ...
            <div className="flex flex-wrap gap-3">
              {savedId ? (
                <Button asChild>
                  <Link to="/app/records/$id" params={{ id: savedId }}>
                    Open record
                  </Link>
                </Button>
              ) : null}
  ...
  return (
    <aside className="space-y-4 rounded-xl border border-border bg-surface p-4 text-sm">
      ...
      <p className="text-xs text-muted-foreground">
        {PRODUCT_NAME} never invents attendees, votes, quorum or signatures. Anything missing is listed
        above.
      </p>
    </aside>
  );
...
function RecommendationStep({
  ...
  form: { description: string; eventDate: string; effectiveDate: string; meetingOccurred: "yes" | "no" | "unsure"; participants: string; approvers: string; notes: string };
