...
const searchSchema = z.object({ intent: z.string().optional() });
...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Create a free ${PRODUCT_NAME} account and generate your first business record draft.`,
      },
      { property: "og:title", content: `Create your account — ${PRODUCT_NAME}` },
      {
        property: "og:description",
        content: "Start free. No credit card required. Generate your first business record.",
      },
...
function SignupPage() {
  ...
  async function onSubmit(event: React.FormEvent) {
    ...
    navigate({ to: "/app/onboarding", search: { intent: intent ?? "record" } });
  }
    ...
    >
      <form onSubmit={onSubmit} className="space-y-5" noValidate>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link to="/login" search={{ intent }} className="font-medium text-primary hover:underline">
            Log in
          </Link>
        </p>
      </form>
